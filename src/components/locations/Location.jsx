...
const Location = () => {
  ...
  return (
    ...
    <div id='sucursales' className='w-full h-fit mx-auto mb-20'>

        <div className="flex flex-col justify-center items-center w-[100%] h-[100px] px-16 mt-[5rem] mb-4">
          <h1 className='font-cabin lg:text-3xl text-xl text-center font-semibold lg:font-normal bg-orange-400 px-10 py-2 rounded'>Contamos con 2 sucursales</h1>
        </div>
        ...
        <div className='flex flex-col lg:flex-row justify-evenly items-center w-full'>
          ...
          <div className='flex flex-col justify-center items-center py-10 lg:w-[50%] w-[90%]'>
            ...
            <div className='pb-7'>
              <h2 className='font-cabin lg:text-xl text-center bg-slate-200 px-6 py-2 my-2 rounded'>General Enrique Yaqueme 1167</h2>
            </div>
          ...
          <div className='flex flex-col justify-center items-center py-10 lg:w-[50%] w-[90%] '>
            ...
            <div className='pb-7'>
              <h2 className='font-cabin lg:text-xl text-center bg-slate-200 px-6 py-2 my-2 rounded'>Colectora Norte y Vicente López</h2>
            </div>
