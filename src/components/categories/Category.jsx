...
const Category = (props) => {
    ...
    return (
      <div className='group flex flex-col justify-center items-center lg:h-[350px] lg:w-[380px] h-[300px] w-[340px] p-2 border shadow-lg rounded cursor-pointer bg-slate-100/50'>
